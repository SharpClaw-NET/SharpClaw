...
To enable, add to your core .env Modules section:
  "sharpclaw_registration_dev": "true"
...
All workspace I/O is sandboxed to external-modules/{registration_id}/.
...
mdk_scaffold_module
  ...
  Creates .csproj, module class, package.json, and optional tool stubs.
  Params: registration_id (string, required), display_name (string, required),
...
mdk_write_file
  ...
  Params: registration_id (string, required), relative_path (string, required),
...
mdk_list_files
  ...
  Params: registration_id (string, required),
...
mdk_describe_module_system
  Concise reference card of the IKernelRegistrationSource contract: interface,
...
────────────────────────────────────────
Workspace sandbox:
  - File I/O scoped to external-modules/{registration_id}/
